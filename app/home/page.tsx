...
import animation from '../svg/animation.json'
...
const Main = () => {
    return (
        <>
            <div className="bg-white dark:bg-black dark:text-white pb-6 sm:pb-8 lg:pb-20" id='home'>
                    ...
                    <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
                        <div className="flex flex-col justify-between xl:w-5/12">
                            ...
                            <div className="sm:text-center lg:py-12 lg:text-left xl:py-24">
                                ...
                                <h1 className="mb-8 text-4xl font-bold sm:text-5xl md:mb-12 md:text-6xl">Revolutionary way to build the web</h1>
